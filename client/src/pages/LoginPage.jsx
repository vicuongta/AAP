      ...
      <div className="w-full max-w-md flex flex-col items-center gap-4 py-4">
        ...
        <div className="w-full bg-white rounded-3xl shadow-lg p-8">
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <button
              type="button"
              className="w-full py-3 border border-gray-300 rounded-3xl font-semibold flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors cursor-pointer"
            >
