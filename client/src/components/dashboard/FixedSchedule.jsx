      ...
      <div className="px-3 py-2.5 border-b border-gray-50">
        <div className="flex items-center justify-between mb-2">
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-gray-700">Your Fixed Schedule</h3>
          ...
          return (
            <div key={item.id} className="px-2.5 py-1.5 hover:bg-gray-50/40 transition-colors">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-[#2d6a4f]/8 flex items-center justify-center flex-shrink-0">
