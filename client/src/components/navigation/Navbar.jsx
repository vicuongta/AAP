        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <Link to={createPageUrl('Login')}>
              <Button variant="ghost" className="text-gray-700 hover:text-[#2d6a4f] rounded-full px-5 cursor-pointer">
                Log in
              </Button>
            </Link>
            <Link to={createPageUrl('Register')}>
              <Button className="bg-[#2d6a4f] hover:bg-[#1b4332] text-white rounded-full px-5 cursor-pointer">
                Sign Up
              </Button>
            </Link>
          </div>
